...
public class HandleDatePickerTest{
    ...
    @Test(description="handle datePicker test",priority=0)
    public void datePickerTest() throws InterruptedException{
       Reporter.log("Started executing the datePickerTest ",true);

        Reporter.log(" switch to the iframe",true);
        driver.switchTo().frame(0);


       Reporter.log("click on datepicker element",true);
