...
public class ActionsDemoTest{
    ...
    @Test(description="dragAnddropTest",priority=0)
    public void dragAndDropTest() throws InterruptedException{
       ...
       driver.findElement(By.xpath("//a[normalize-space()='Droppable']")).click();
        String droppableTitle="Droppable | jQuery UI";
        wait.until(ExpectedConditions.titleIs(droppableTitle));
        Assert.assertEquals(driver.getTitle(),droppableTitle);
        Reporter.log(" switch to the iframe",true);
        driver.switchTo().frame(0);

       Reporter.log("identify source element",true);
...
driver.switchTo().defaultContent();
    ...
    @Test(description="dragAnddropTest",priority=1)
    public void dragAndDropByTest() throws InterruptedException{
        Reporter.log("Started executing the dragAndDropTest ",true);

        driver.findElement(By.xpath("//a[normalize-space()='Draggable']")).click();
        String draggableTitle="Draggable | jQuery UI";
        wait.until(ExpectedConditions.titleIs(draggableTitle));
        Assert.assertEquals(driver.getTitle(),draggableTitle);
        Reporter.log(" switch to the iframe",true);
        driver.switchTo().frame(0);
