...
public LoginPage loginPage;
 ...
 public void TC01_Verify_register_an_account_using_faker_test_data_Test(){
       ...
       try{
           ...
           Assert.assertEquals(registerPage.getAccountCreatedHeaderExists(),Constants.YOUR_ACCNT_CREATED_HEADER);
           Assert.assertEquals(registerPage.getAccountCreatedSucMsg(),Constants.YOUR_ACCNT_CREATED_SUCC_MSG);
