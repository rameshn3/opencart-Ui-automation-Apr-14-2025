...
public class WebDriverUtils{
    ...
    public By getByType(String locator) {
        ...
        try {
            ...
            ChainTestListener.log("By type not found with: " + locatorType);
        }
        return by;
    }
     ...
     * @throws InterruptedException
     */
    public boolean selectOption(List<WebElement> elementList, String option) throws InterruptedException {
    ...
    public boolean isSingleElementExist(By locator) {
        ...
        ChainTestListener.log("actual count of element ===" + actCount);
        if (actCount == 1) {
            return true;
        }
        return false;
    ...
    public void clickByPosition(WebElement element) {
        Point p = element.getRect().getPoint();
    ...
    public void switchFrame(String frameNameId) {
        try {
            ...
            ChainTestListener.log("Cannot switch to iframe");
        }
    }
    ...
    public static String getCurrentDay() {
        ...
        ChainTestListener.log("Today Int: " + todayInt + "\n");
        // Integer to String Conversion
        String todayStr = Integer.toString(todayInt);
        ChainTestListener.log("Today Str: " + todayStr + "\n");
        return todayStr;
    }
    /**
    ...
    public String waitForTitleContains(String titleFractionValue) {
        if(wait.until(ExpectedConditions.titleContains(titleFractionValue))) {
            ...
            ChainTestListener.log("expected title is not visible...");
            return null;
        }
    }
    ...
    public String waitForUrlContains(String urlFractionValue) {
        if(wait.until(ExpectedConditions.urlContains(urlFractionValue))) {
            ...
            ChainTestListener.log("expected url is not visible...");
            return null;
        }
    }
    ...
    public WebElement retryingElement(By locator, int timeOut) throws InterruptedException {
        ...
        while (attempts < timeOut) {
            try {
                element = getElement(locator);
                ChainTestListener.log("element is found in attempt: " + attempts);
                break;
            } catch (NoSuchElementException e) {
                ChainTestListener.log("element is not found in attempt : " + attempts + " for " + locator);
        ...
        if(element == null) {
            ChainTestListener.log("element is not found....tried for : " + timeOut + " secs " +
    ...
    public void waitForPageLoad(int timeOut) {
        ...
        while (System.currentTimeMillis() < endTime) {
            ...
            if (pageState.equals("complete")) {
                ChainTestListener.log("page DOM is fully loaded now.....");
                break;
            }
