...
public class LoginPageTest extends TestBase{
    ...
    @Test(description="TC02_Verify login page url test")
    public void TC02_verify_login_page_url_Test(){
        ChainTestListener.log("TC02_Verify login page url test");
        Assert.assertTrue(loginPg.getLoginPageUrl().contains(Constants.LOGIN_PAGE_FRACTION_URL));
    }

    @Test(description="TC03 Verify login page elements test")
    public void TC03_verify_login_page_elements_Test(){
        ChainTestListener.log("TC03 Verify login page elements test");
        Assert.assertTrue(loginPg.isLoginBreadCrumbExits());
        Assert.assertTrue(loginPg.isNewCustomerHeaderExits());
        Assert.assertTrue(loginPg.isReturningCustomerHeaderExits());
    }
